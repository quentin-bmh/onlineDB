...
// Initialiser la première section active si aucune
if (!document.querySelector('.voie-content.active')) {
  const firstSection = document.querySelector('.voie-content');
  if (firstSection) {
    firstSection.classList.add('active');
    firstSection.style.display = 'block';
    firstSection.style.animationName = 'slideInUp';
  }
}
